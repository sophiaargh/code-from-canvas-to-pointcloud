...
Usage:
    python lora/export_pointclouds.py --condition photographs
    python lora/export_pointclouds.py --condition mixed_baseline --styled_root /scratch/...
    python lora/export_pointclouds.py --condition mixed_lora --lora_path /scratch/.../final
"""
...
def get_args():
    ...
    p.add_argument("--condition", required=True,
                   choices=["photographs", "mixed_baseline", "mixed_lora", "mixed_lora_const"])
...
def main():
    ...
    if args.condition in ("mixed_lora", "mixed_lora_const"):
